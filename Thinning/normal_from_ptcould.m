function [ normals, curvature ] = normal_from_ptcould(points, numNeighbours, viewPoint, dirLargest)
%
...
% In fact, this part can be replaced with a more easier way if we know points come with fixed order.
% create kdtree
...
p = repmat(points(:,1:2),numNeighbours,1) - points(n(:),1:2);
